...
export function calculateTax(income) {
  ...
  if (income > 0 && income <= 10000) return totalIncomeTaxToPay;
  else if (income > 10000 && income <= 30000) return 0.1 * (income - 10000);
  else if (income > 30000 && income <= 70000)
    return 2000 + 0.2 * (income - 30000);
  else if (income > 70000) return 2000 + 8000 + 0.3 * (income - 70000);
}
